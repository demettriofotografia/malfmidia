...
const AboutUs: React.FC<AboutUsProps> = ({ content }) => {
  ...
  return (
    <section ref={sectionRef} className="relative bg-[#020202] overflow-hidden py-12 md:py-24">
      {/* TEXTURA DE FUNDO - Light Leak / Flare (Conforme solicitado) */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        {/* Camada de ruído/grão */}
        <div className="absolute inset-0 opacity-[0.03] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] mix-blend-overlay"></div>
        
        {/* Efeito de Flare Laranja inspirado na imagem enviada */}
        ...
        <div className="absolute -left-[20%] bottom-[-20%] w-[70%] h-[100%] opacity-20 mix-blend-screen -rotate-12 blur-[60px]">
           <img 
        ...
        {/* Gradiente Central de Profundidade */}
